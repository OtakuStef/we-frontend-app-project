      ...
      <div class="container align-items-center">
        <div class="card-container row">
          <div id="gameListCard" class="btn col-md-4 px-0">
            <div class="card m-2">
              <img src="../../public/gameListImage.jpg" alt="chessboard showing a pawn with a crown">
              <div class="card-body">
          ...
          <div id="pileOfShameCard" class="btn col-md-4 px-0">
            <div class="card m-2">
              <img src="../../public/pileOfShameImage.jpg" alt="pink and blue xbox controller">
              <div class="card-body">
          ...
          <div id="userCard" class="btn col-md-4 px-0">
            <div class="card m-2">
              <img src="../../public/userAccountImage.jpg" alt="colleagues working on a project with pen and paper">
              <div class="card-body">
